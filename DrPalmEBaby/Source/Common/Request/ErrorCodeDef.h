...
#define AccountNotExist         @"200001"   //帐号不存在
#define LoginInfoNotMatch       @"200002"   //帐号或密码错误
#define LoginParamEmpty         @"200003"   //登录帐号、密码、学校ID为空
#define InvalidSessionKey       @"200004"   //SessionKey无效(被踢下线)
...
#define OvertimeSessionKey      @"200014"   //SessionKey超时

...
//        [localContext setStalenessInterval:0.0];
//        [localContext setMergePolicy:[[[NSMergePolicy alloc] initWithMergeType:NSMergeByPropertyObjectTrumpMergePolicyType] autorelease]];
...
//    }
	...
	NSArray *allModels = [NSArray arrayWithObjects:@"School", @"Class", @"SystemMessage", @"Communicate", @"Common", @"LastUpdate", @"Settings", nil];

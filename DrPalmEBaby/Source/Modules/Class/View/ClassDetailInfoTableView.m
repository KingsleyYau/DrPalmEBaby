...
@interface ClassDetailInfoTableView () <UITableViewDelegate, UITableViewDataSource, EKEventEditViewDelegate> {
    
}
@property (nonatomic, retain) NSArray *itemArray;
@end

@implementation ClassDetailInfoTableView

//
//  ClassAttachmentViewController.m
//  DrPalm4EBaby
//
...
@interface ClassAttachmentViewController () <RequestImageViewDelegate, ClassAttachmentDownloaderDelegate>  {
    NSInteger _curIndex;
    BOOL _fullScreen;
...
@implementation ClassAttachmentViewController
...
- (void)setupNavigationBar {
    ...
    titleLabel.text = NSLocalizedString(@"ClassAttachmentViewNavigationTitle", nil);

//
//  ClassAlbumnDetailViewController.m
//  DrPalm4EBaby
//
...
@interface ClassAlbumnDetailViewController () <RequestImageViewDelegate, ClassRequestOperatorDelegate, ClassAttachmentDownloaderDelegate>  {
    NSInteger _curIndex;
    BOOL _fullScreen;
...
@implementation ClassAlbumnDetailViewController
...
- (void)setupNavigationBar {
    ...
    titleLabel.text = NSLocalizedString(@"ClassAlbumnDetailNavigationTitle", nil);

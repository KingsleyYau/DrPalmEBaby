//
//  ClassAttachmentViewController.h
//  DrPalm4EBaby
//
...
@class ClassEvent;
@interface ClassAttachmentViewController : ShareDetailViewController <ShareItemDelegate, ClassDetailInfoTableViewDelegate, PZPagingScrollViewDelegate>

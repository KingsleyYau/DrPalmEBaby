...
@interface SchoolAlbumnDetailViewController () <RequestImageViewDelegate, SchoolRequestOperatorDelegete, SchoolAttachmentDownloaderDelegate> {
    NSInteger _curIndex;
...
@implementation SchoolAlbumnDetailViewController

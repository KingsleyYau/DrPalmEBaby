//
//  SchoolMainListViewController.m
//  DrPalm4EBaby
//
...
@interface SchoolMainListViewController () <SchoolRequestOperatorDelegete, EGORefreshTableHeaderDelegate> {
    NSInteger _maxItem;
    BOOL _hasMore;
    BOOL _reloading;
    BOOL _loadMore;
...
@implementation SchoolMainListViewController
